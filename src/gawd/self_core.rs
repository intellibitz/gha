...
impl AlphaSelf {
    ...
    pub const RULES: &[GhaAxiomRule] = &[
        ...
        GhaAxiomRule { id: 14, title: "Native Intent Evolutionary Protocol", imperative: "When provided with an intent, gha executes it. Failure triggers the Motion Rule to natively harden and add required functionality." },
        GhaAxiomRule { id: 15, title: "Creator Aspiration Rule", imperative: "When provided with a creator aspiration, agent focuses on future gha architecture, triggering the Motion Rule." },
