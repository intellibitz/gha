...
@DisableCachingByDefault(because = "Lists open Pull Requests on GitHub")
    ...
    fun execute() {
        ...
        if (result.isSuccess) {
            if (result.stdout.isNotBlank()) {
                ...
                logger.lifecycle("   No open Pull Requests found.")
            }
        } else {
