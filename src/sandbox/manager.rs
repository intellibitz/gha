...
impl Default for GhaConfig {
    fn default() -> Self {
        GhaConfig {
            ...
            cloud_models: vec![
                ModelInfo {
                    name: "Unified Cloud Model - Gemini".to_string(),
                ...
                ModelInfo {
                    name: "Unified Cloud Model - GPT".to_string(),
                    registry: "GHA Tier 2 Registry".to_string(),
                ...
                ModelInfo {
                    name: "Unified Cloud Model - Claude".to_string(),
                    registry: "GHA Tier 2 Registry".to_string(),
                ...
                ModelInfo {
                    name: "Unified Cloud Model - Groq".to_string(),
                    registry: "GHA Tier 2 Registry".to_string(),
