...
GitHub users and developers across any IDE or terminal can clone or install this project and expect **0% system modifications**. All dependencies, Kotlin libraries, Gradle caches, JDK toolchains, AI models, and execution state are strictly sandboxed inside `.gha/`.
...
- **📦 AI Model & MCP Tool Hub**: Download, cache, and manage freely available AI models (`.gha/models/`) and community MCP servers (`.gha/mcp/`).
